...
func (w *worker) prepareWork(genParams *generateParams) (*environment, error) {
	...
	if (w.chainConfig.IsCommonsBudgetActivated(header.Number)) {
		bosagora.RewardCommonsBudget(header.Number, w.chainConfig.CommonsBudget, w.chainConfig.LastCommonsBudgetRewardBlock, w.chainConfig.CommonsBudgetReward, env.state)
	}
