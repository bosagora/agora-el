...
import (
	...
	"github.com/ethereum/go-ethereum/core/bosagora"
...
type generateParams struct {
	...
	commonsBudget   				common.Address // commons budget address
	commonsBudgetReward 			big.Int
	lastCommonsBudgetRewardBlock 	big.Int
}
...
func (w *worker) prepareWork(genParams *generateParams) (*environment, error) {
	...
	bosagora.RewardCommonsBudget(header.Number, genParams.commonsBudget, genParams.lastCommonsBudgetRewardBlock, genParams.commonsBudgetReward, env.state)
...
func (w *worker) commitWork(interrupt *int32, noempty bool, timestamp int64) {
	...
	work, err := w.prepareWork(&generateParams{
		...
		coinbase:  coinbase,
		commonsBudget: w.chainConfig.CommonsBudget,
		commonsBudgetReward: w.chainConfig.CommonsBudgetReward,
		lastCommonsBudgetRewardBlock: w.chainConfig.LastCommonsBudgetRewardBlock,
	})
	if err != nil {
		return
	}
